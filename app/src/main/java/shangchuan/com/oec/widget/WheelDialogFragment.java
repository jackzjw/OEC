...
import shangchuan.com.oec.util.ScreenUtil;
...
public class WheelDialogFragment extends DialogFragment implements WheelView.OnValueChangeListener {
    ...
    public static WheelDialogFragment newInstance(String[] wheel) {
        return newInstance(wheel, "取消", "确定", true, true,true);
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        //设置窗口以对话框样式显示
        setStyle(DialogFragment.STYLE_NO_TITLE, R.style.loading_dialog_style);
        //设置对话框背景色，否则有虚框
    ...
    private void setSubView() {
        ...
        wheelView.setDividerColor(ContextCompat.getColor(App.getInstance(),R.color.colorPrimary));
        wheelView.setSelectedTextColor(ContextCompat.getColor(App.getInstance(),R.color.colorPrimary));
        wheelView.setNormalTextColor(ContextCompat.getColor(App.getInstance(),R.color.default_text_color_normal));
    }
