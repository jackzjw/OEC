...
public class ModifyWRDetailActivity extends BaseActivity<AddWorkReportPresent> implements AddApplyContract.View,View.OnClickListener {
   ...
   public static Intent getInstance(Context context, WorkReportDetailsBean bean){
       Intent intent =new Intent(context,ModifyWRDetailActivity.class);
       intent.putExtra("bean",bean);
       return intent;
   }
    @Override
    protected void initEventData() {
        mToolbarTitle.setText("修改工作报告");
        ...
        mLink.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                PickerUtil.getInstance().setOptionPick(ModifyWRDetailActivity.this,new String[]{"图片","视频","文件"})
        ...
        mAddOwner.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivityForResult(new Intent(ModifyWRDetailActivity.this,ApproverActivity.class), Constants.REQUEST_CODE);
            }
        });
        //文件列表
    ...
    private void openMedia(int MediaType){
        ...
        adapter.setOnItemClickListener(new GridImgAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int position, View v) {
                // 这里可预览图片
                PictureConfig.getPictureConfig().externalPicturePreview(ModifyWRDetailActivity.this, position, selectMedia);
            }
        });
    ...
    private void fillData() {
        //填充数据
        mData=getIntent().getParcelableExtra("bean");
        ...
        for(AttchmentBean item:mData.getAttachmentList_new()){
    ...
    public void AddSuccess() {
        LoadingView.dismissProgress();
        ToastUtil.show("提交成功");
        startActivity(new Intent(this,WorkReportListActivity.class));
        finish();
    }
    @Override
