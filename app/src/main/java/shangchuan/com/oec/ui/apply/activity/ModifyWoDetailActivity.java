...
public class ModifyWoDetailActivity extends BaseActivity<AddWoPresent> implements AddWoContract.View {
    ...
    private void filledData() {
        mData=(WoDetailBean)getIntent().getParcelableExtra("bean");
        ...
        for(AttchmentBean item:mData.getListA()){
    ...
    protected void initEventData() {
        ...
        mParentName.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                LoadingView.showProgress(ModifyWoDetailActivity.this);
        ...
        mChildName.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                PickerUtil.getInstance().setOptionPick(ModifyWoDetailActivity.this,childArray)
        ...
        mRelLink.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                PickerUtil.getInstance().setOptionPick(ModifyWoDetailActivity.this,new String[]{"图片","视频","文件"})
                        .setOnOptionPickListener(new OptionPicker.OnOptionPickListener() {
                            @Override
                            public void onOptionPicked(int index, String item) {
                                switch (index){
        ...
        adapter.setOnItemClickListener(new GridImgAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int position, View v) {
                // 这里可预览图片
                PictureConfig.getPictureConfig().externalPicturePreview(ModifyWoDetailActivity.this, position, selectMedia);
        ...
        mAddOwner.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivityForResult(new Intent(ModifyWoDetailActivity.this,ApproverActivity.class), Constants.REQUEST_CODE);
            }
        });
        filledData();
        //文件列表
    ...
    public void showParentData(String[] parentTitles) {
        ...
        PickerUtil.getInstance().setOptionPick(ModifyWoDetailActivity.this,parentTitles)
                .setOnOptionPickListener(new OptionPicker.OnOptionPickListener() {
                    @Override
                    public void onOptionPicked(int index, String item) {
